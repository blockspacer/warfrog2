...
undead_bicep_r =
{
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Undead r Bicep",
	directObjectTemplate = "object/tangible/wearables/armor/deathtrooper/armor_deathtrooper_bicep_r.iff",
	craftingValues = {
	         {"armor_rating",1,1,0},
...
addLootItemTemplate("undead_bicep_r", undead_bicep_r)
