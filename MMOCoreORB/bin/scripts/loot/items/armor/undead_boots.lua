...
undead_boots =
{
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Undead Boots",
	directObjectTemplate = "object/tangible/wearables/armor/deathtrooper/armor_deathtrooper_boots.iff",
	craftingValues = {
	         {"armor_rating",1,1,0},
...
addLootItemTemplate("undead_boots", undead_boots)
