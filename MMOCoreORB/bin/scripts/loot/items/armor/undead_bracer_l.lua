...
undead_bracer_l =
{
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Undead L Bracer",
	directObjectTemplate = "object/tangible/wearables/armor/deathtrooper/armor_deathtrooper_bracer_l.iff",
	craftingValues = {
	         {"armor_rating",1,1,0},
...
addLootItemTemplate("undead_bracer_l", undead_bracer_l)
