...
undead_bracer_r =
{
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Undead r Bracer",
	directObjectTemplate = "object/tangible/wearables/armor/deathtrooper/armor_deathtrooper_bracer_r.iff",
	craftingValues = {
	         {"armor_rating",1,1,0},
...
addLootItemTemplate("undead_bracer_r", undead_bracer_r)
