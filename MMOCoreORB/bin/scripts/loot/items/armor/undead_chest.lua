...
undead_chest =
{
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Undead Chest Plate",
	directObjectTemplate = "object/tangible/wearables/armor/deathtrooper/armor_deathtrooper_chest_plate.iff",
	craftingValues = {
	         {"armor_rating",1,1,0},
...
addLootItemTemplate("undead_chest", undead_chest)
