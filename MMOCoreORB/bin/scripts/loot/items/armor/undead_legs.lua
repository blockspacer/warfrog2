...
undead_legs =
{
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Undead Leggings",
	directObjectTemplate = "object/tangible/wearables/armor/deathtrooper/armor_deathtrooper_leggings.iff",
	craftingValues = {
	         {"armor_rating",1,1,0},
...
addLootItemTemplate("undead_legs", undead_legs)
