...
veteranRewards = {
	...
	{templateFile = "object/tangible/veteran_reward/frn_vet_r2_toy.iff", milestone=30, oneTime=true, description="@veteran_new:mini_r2"},

	-- 180 Day Rewards
	{templateFile = "object/tangible/deed/vehicle_deed/speederbike_deed.iff", milestone=60, oneTime=false, description="A new Speederbike to help you get around"},
	...
	{templateFile = "object/tangible/veteran_reward/frn_couch_falcon_section_s01.iff", milestone=1560, oneTime=false, description="@veteran_new:falconchair"},
	{templateFile = "object/tangible/veteran_reward/frn_vet_tie_fighter_toy.iff", milestone=60, oneTime=true, description="@veteran_new:mini_tiefighter"},
	{templateFile = "object/tangible/veteran_reward/frn_vet_x_wing_toy.iff", milestone=60, oneTime=true, description="@veteran_new:mini_xwing"},
	...
	-- 360 Day Rewards
	{templateFile = "object/tangible/veteran_reward/harvester.iff", milestone=120, oneTime=true, description="@veteran_new:poweredharvester"},
